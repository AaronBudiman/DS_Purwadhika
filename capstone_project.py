        ...
        while True: 
            ...
            if inputMenu2 == '1':
                ...
                if True in listTrue :# Kalau Data sudah ada(True), akan ditolak
                    ...
                    tambahBuah = str(input('Masukan Nama Buah : ')).capitalize()
                    tambahStock = int(input('Masukan Stock Buah : '))
                    tambahAsal = str(input('Masukan Asal Buah : ')).capitalize()
                    if len(tambahAsal) < 9:
                        tambahAsal = tambahAsal + ' '*(9-len(tambahAsal))
                    tambahHarga = int(input('Masukan Harga Buah : '))
                        ...
                        if inputLanjutUpdate == 'Y':
                            while True: # Looping (Bagian Tanya Column yang ingin diubah)
                                ...
                                if inputMenu3Sub1Ubah in ['Nama','Asal','Harga','Stock']:
                                    inputUpdateStockStr = str(input('Masukan Data yang Baru : ')).capitalize()
